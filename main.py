...
if __name__ == '__main__':
    ...
    anilist_users = {user_id: u for u in anilist_usernames if u and (user_id := anilist.get_user_id(u))}
    ...
    for user_id, media_list in users_missing_media.items():
        ...
        print(f'{anilist_users[user_id]},{anilist_media[random.choice(list(possible_media))]}')
